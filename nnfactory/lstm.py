...
Author: Xihao Liang
Created: 2016.07.08
Description: a factory for building the LSTM layer
'''
...
def build_layer(
	...
	dim_output = tparams['%s_b'%(prefix)].shape[0] / 4
	...
	def _step(m_, x_, h_, c_):
		...
		o = T.nnet.sigmoid(_slice(preact, 2, dim_output))
		c = T.tanh(_slice(preact, 3, dim_output))
