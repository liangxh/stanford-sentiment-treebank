...
def build(options):
	...
	proj = unit.gru.build(tparams, 'gru', emb, mask, options['dim_wemb'], options['dim_hidden'])
	proj = unit.rnn.build(tparams, 'rnn', proj, mask, options['dim_hidden'], options['dim_hidden'])
