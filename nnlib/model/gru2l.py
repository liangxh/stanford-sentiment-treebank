...
def build(options):
	...
	proj = unit.gru.build(tparams, 'gru1', emb, mask, options['dim_wemb'], options['dim_hidden'])
	proj = unit.gru.build(tparams, 'gru2', proj, mask, options['dim_hidden'], options['dim_hidden'])
